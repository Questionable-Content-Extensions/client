...
export class ComicService {
  ...
  _updateComic() {
    ...
    this.comic = comic;
    this.nextComic =
      this.comic + 1 > this.latestComic ? this.latestComic : this.comic + 1;
  ...
  refreshComicData() {
    if (typeof this.comic === "undefined") {
      this.$log.debug(
        "comicService::refreshComicData() called " +
  ...
  addItemToComic(item: ComicItem) {
    ...
    return this.$http
      .post(constants.addItemToComicUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  removeItem(item: ComicItem) {
    ...
    return this.$http
      .post(constants.removeItemFromComicUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setTitle(title: string) {
    ...
    return this.$http
      .post(constants.setComicTitleUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setTagline(tagline: string) {
    ...
    return this.$http
      .post(constants.setComicTaglineUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setPublishDate(publishDate: Date, isAccurate: boolean) {
    ...
    return this.$http
      .post(constants.setPublishDateUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setGuestComic(value: boolean) {
    ...
    return this.$http
      .post(constants.setGuestComicUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setNonCanon(value: boolean) {
    ...
    return this.$http
      .post(constants.setNonCanonUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setNoCast(value: boolean) {
    ...
    return this.$http
      .post(constants.setNoCastUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setNoLocation(value: boolean) {
    ...
    return this.$http
      .post(constants.setNoLocationUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setNoStoryline(value: boolean) {
    ...
    return this.$http
      .post(constants.setNoStorylineUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setNoTitle(value: boolean) {
    ...
    return this.$http
      .post(constants.setNoTitleUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  setNoTagline(value: boolean) {
    ...
    return this.$http
      .post(constants.setNoTaglineUrl, data)
      .then((r) => this._onSuccessRefreshElseErrorLog(r))
      .catch((r) => this._onErrorLog(r));
  }
  ...
  nextRandomComic() {
    ...
    while (randomComic == this.comic) {
      randomComic = Math.floor(
        Math.random() * (parseInt(this.latestComic) + 1)
      );
    }
    return randomComic;
  }
  ...
  async nextFilteredRandomComic() {
    ...
    this.$log.debug(
      "comicService::nextFilteredRandomComic() excluded comics",
      excludedComics
    );

    let nextRandomComic = this.comic;
    while (
      nextRandomComic == this.comic ||
      excludedComics.includes(nextRandomComic)
    ) {
